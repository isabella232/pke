...
/*
PostPKENodeStatus Report to Pipeline the progress of the bootstrapping of a new node (to be called by PKE installer)
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId Organization identifier
 * @param id Cluster identifier
 * @param postPkeNodeStatusRequest
*/
func (a *ClustersApiService) PostPKENodeStatus(ctx _context.Context, orgId int32, id int32, postPkeNodeStatusRequest PostPkeNodeStatusRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &postPkeNodeStatusRequest
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
