...
*ClustersApi* | [**PostPKENodeStatus**](docs/ClustersApi.md#postpkenodestatus) | **Post** /api/v1/orgs/{orgId}/clusters/{id}/pke/status | Report to Pipeline the progress of the bootstrapping of a new node (to be called by PKE installer)
...
## Documentation For Models
 ...
 - [PostPkeNodeStatusRequest](docs/PostPkeNodeStatusRequest.md)
