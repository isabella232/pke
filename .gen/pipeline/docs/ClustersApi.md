...
[**PostPKENodeStatus**](ClustersApi.md#PostPKENodeStatus) | **Post** /api/v1/orgs/{orgId}/clusters/{id}/pke/status | Report to Pipeline the progress of the bootstrapping of a new node (to be called by PKE installer)
...
> PostPKENodeStatus(ctx, orgId, id, postPkeNodeStatusRequest)
...
**orgId** | **int32**| Organization identifier | 
**id** | **int32**| Cluster identifier | 
**postPkeNodeStatusRequest** | [**PostPkeNodeStatusRequest**](PostPkeNodeStatusRequest.md)|  | 
